...
// ============================== Calculate the covariance matrix ============ ===============
 // Stored in rows, as a behavior vector, the input matrix mat is m rows and n columns, then the covariance matrix covar is a symmetric matrix with n rows and n columns, and the mean value is 1 row and n columns
