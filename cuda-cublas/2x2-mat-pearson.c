...
// I have converted the 2D data matrix into row-major format in
// GPU memory and I have verified that the copy is correctly made.
// The vectors are stored as a matrix of size 900000 (ie. 450*20000) in row major format.
