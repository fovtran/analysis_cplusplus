...
"""LaTeX math mode commands with approximately matching Unicode character"""
...
# I/O
outfile = file('../cmd_substitutions.tex', 'w')
# outfile = sys.stdout
...
# Parse, Filder and sort data::

data = parse_unimathsymbols.read_data()
data = parse_unimathsymbols.substitution_commands(data)
