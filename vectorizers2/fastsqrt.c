...
The doozy was when I tried the SSE op for reciprocal square root, and then used a multiply to get the square root ( x * 1/vx = vx ). Even though this takes two dependent operations, it was the fastest solution by far, at 1.24ns/float and accurate to 2-14:
